...
with codecs.open('input_str.utf8', 'r', 'utf8') as f_input:
  input_str = f_input.readlines()[0]

with codecs.open('punctuations.utf8', 'r', 'utf8') as f_punc:
  punctuations = f_punc.readlines()[0]
...
while pos_end < input_length:
  ...
  pos_end += 1
  # handle max character length case
